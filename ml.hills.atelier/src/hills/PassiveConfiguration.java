...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Passive Configuration</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link hills.PassiveConfiguration#getProprietes <em>Proprietes</em>}</li>
 *   <li>{@link hills.PassiveConfiguration#getActivites <em>Activites</em>}</li>
 * </ul>
 *
 * @see hills.HillsPackage#getPassiveConfiguration()
 * @model annotation="gmf.node label='libelle' figure='rounded' size='55,80' label.icon='false' border.width='2' border.color='0,0,0'"
 * @generated
 */
public interface PassiveConfiguration extends Configuration {
	/**
	 ...
	 * @see hills.HillsPackage#getPassiveConfiguration_Proprietes()
	 ...
	 * @see hills.HillsPackage#getPassiveConfiguration_Activites()
	 * @model containment="true"
	 *        annotation="gmf.compartment layout='free'"
	 * @generated
	 */
