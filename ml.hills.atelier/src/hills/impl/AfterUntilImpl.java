 ...
 * </p>
 * <ul>
 *   <li>{@link hills.impl.AfterUntilImpl#getStartDelimiter <em>Start Delimiter</em>}</li>
 *   <li>{@link hills.impl.AfterUntilImpl#getEndDelimiter <em>End Delimiter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AfterUntilImpl extends ScopeImpl implements AfterUntil {
	...
	protected EClass eStaticClass() {
		return HillsPackage.Literals.AFTER_UNTIL;
	}
		...
		if (startDelimiter != null && startDelimiter.eIsProxy()) {
			...
			if (startDelimiter != oldStartDelimiter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, HillsPackage.AFTER_UNTIL__START_DELIMITER, oldStartDelimiter, startDelimiter));
			}
		}
	...
	public void setStartDelimiter(Proposition newStartDelimiter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HillsPackage.AFTER_UNTIL__START_DELIMITER, oldStartDelimiter, startDelimiter));
	}
	...
	public Proposition getEndDelimiter() {
		if (endDelimiter != null && endDelimiter.eIsProxy()) {
			...
			if (endDelimiter != oldEndDelimiter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, HillsPackage.AFTER_UNTIL__END_DELIMITER, oldEndDelimiter, endDelimiter));
			}
		}
		return endDelimiter;
	}
	...
	public void setEndDelimiter(Proposition newEndDelimiter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HillsPackage.AFTER_UNTIL__END_DELIMITER, oldEndDelimiter, endDelimiter));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case HillsPackage.AFTER_UNTIL__START_DELIMITER:
				if (resolve) return getStartDelimiter();
				return basicGetStartDelimiter();
			case HillsPackage.AFTER_UNTIL__END_DELIMITER:
