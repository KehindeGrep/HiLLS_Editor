...
/**
 * This is the item provider adapter for a {@link hills.Declaration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DeclarationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Declaration_ename_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Declaration_ename_feature", "_UI_Declaration_type"),
				 HillsPackage.Literals.DECLARATION__ENAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(HillsPackage.Literals.DECLARATION__DECLARATIONS);
			childrenFeatures.add(HillsPackage.Literals.DECLARATION__PREDICATS);
		}
	...
	public String getText(Object object) {
		String label = ((Declaration)object).getEname();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(HillsPackage.Literals.DECLARATION__DECLARATIONS,
				 HillsFactory.eINSTANCE.createPortDeclaration()));

		newChildDescriptors.add
			(createChildParameter
				(HillsPackage.Literals.DECLARATION__PREDICATS,
				 HillsFactory.eINSTANCE.createPortDeclaration()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == HillsPackage.Literals.DECLARATION__DECLARATIONS ||
			childFeature == HillsPackage.Literals.DECLARATION__PREDICATS;
