...
/**
 * This is the item provider adapter for a {@link hills.Port} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PortItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Port_pname_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Port_pname_feature", "_UI_Port_type"),
				 HillsPackage.Literals.PORT__PNAME,
				 true,
				 false,
				 false,
	...
	protected void addOthernamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Port_othername_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Port_othername_feature", "_UI_Port_type"),
				 HillsPackage.Literals.PORT__OTHERNAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(HillsPackage.Literals.PORT__ENTREE_PORTS);
		}
	...
	public String getText(Object object) {
		String label = ((Port)object).getPname();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(HillsPackage.Literals.PORT__ENTREE_PORTS,
