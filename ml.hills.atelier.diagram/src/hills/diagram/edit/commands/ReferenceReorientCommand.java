...
public class ReferenceReorientCommand extends EditElementCommand {
	...
	*/
	protected boolean canReorientSource() {
		...
		return HillsBaseItemSemanticEditPolicy.getLinkConstraints().canExistReference_4003(container, getLink(),
				getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		HSpecification container = (HSpecification) getLink().eContainer();
		return HillsBaseItemSemanticEditPolicy.getLinkConstraints().canExistReference_4003(container, getLink(), source,
				getNewTarget());
	}
