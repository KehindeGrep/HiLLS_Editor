 ...
 * @generated
 */
public class InternalTransitionReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public InternalTransitionReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof InternalTransition) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return HillsBaseItemSemanticEditPolicy.getLinkConstraints().canExistInternalTransition_4005(container,
	...
	* @generated
	*/
	protected InternalTransition getLink() {
		return (InternalTransition) getElementToEdit();
	}
