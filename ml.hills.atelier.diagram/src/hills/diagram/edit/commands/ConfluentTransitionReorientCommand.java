 ...
 * @generated
 */
public class ConfluentTransitionReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public ConfluentTransitionReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof ConfluentTransition) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return HillsBaseItemSemanticEditPolicy.getLinkConstraints().canExistConfluentTransition_4004(container,
	...
	* @generated
	*/
	protected ConfluentTransition getLink() {
		return (ConfluentTransition) getElementToEdit();
	}
