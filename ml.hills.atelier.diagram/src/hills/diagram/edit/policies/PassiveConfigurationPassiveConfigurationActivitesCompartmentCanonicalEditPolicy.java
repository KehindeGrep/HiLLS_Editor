 ...
 * @generated
 */
public class PassiveConfigurationPassiveConfigurationActivitesCompartmentCanonicalEditPolicy
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return HillsPackage.eINSTANCE.getPassiveConfiguration_Activites();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<HillsNodeDescriptor> childDescriptors = HillsDiagramUpdater
				.getPassiveConfigurationPassiveConfigurationActivitesCompartment_7008SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return Activity2EditPart.VISUAL_ID == HillsVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<HillsNodeDescriptor> childDescriptors = HillsDiagramUpdater
				.getPassiveConfigurationPassiveConfigurationActivitesCompartment_7008SemanticChildren(
