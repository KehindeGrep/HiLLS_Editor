 ...
 * @generated
 */
public class TransientConfigurationTransientConfigurationActivitesCompartmentCanonicalEditPolicy
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return HillsPackage.eINSTANCE.getTransientConfiguration_Activites();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<HillsNodeDescriptor> childDescriptors = HillsDiagramUpdater
				.getTransientConfigurationTransientConfigurationActivitesCompartment_7010SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return Activity3EditPart.VISUAL_ID == HillsVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<HillsNodeDescriptor> childDescriptors = HillsDiagramUpdater
				.getTransientConfigurationTransientConfigurationActivitesCompartment_7010SemanticChildren(
