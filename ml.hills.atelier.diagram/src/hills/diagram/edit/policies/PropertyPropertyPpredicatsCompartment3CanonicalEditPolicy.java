 ...
 * @generated
 */
public class PropertyPropertyPpredicatsCompartment3CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<HillsNodeDescriptor> childDescriptors = HillsDiagramUpdater
				.getPropertyPropertyPpredicatsCompartment_7022SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<HillsNodeDescriptor> childDescriptors = HillsDiagramUpdater
				.getPropertyPropertyPpredicatsCompartment_7022SemanticChildren((View) getHost().getModel());
