 ...
 * @generated
 */
public class FiniteConfigurationFiniteConfigurationSojTimeCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return HillsPackage.eINSTANCE.getFiniteConfiguration_SojTime();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<HillsNodeDescriptor> childDescriptors = HillsDiagramUpdater
				.getFiniteConfigurationFiniteConfigurationSojTimeCompartment_7006SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return SojournTimeEditPart.VISUAL_ID == HillsVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<HillsNodeDescriptor> childDescriptors = HillsDiagramUpdater
				.getFiniteConfigurationFiniteConfigurationSojTimeCompartment_7006SemanticChildren(
