 ...
 * @generated
 */
public class FiniteConfigurationFiniteConfigurationActivitesCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return HillsPackage.eINSTANCE.getFiniteConfiguration_Activites();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<HillsNodeDescriptor> childDescriptors = HillsDiagramUpdater
				.getFiniteConfigurationFiniteConfigurationActivitesCompartment_7005SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return ActivityEditPart.VISUAL_ID == HillsVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<HillsNodeDescriptor> childDescriptors = HillsDiagramUpdater
				.getFiniteConfigurationFiniteConfigurationActivitesCompartment_7005SemanticChildren(
