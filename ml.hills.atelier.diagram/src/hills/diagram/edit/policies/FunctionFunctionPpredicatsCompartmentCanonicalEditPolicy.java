 ...
 * @generated
 */
public class FunctionFunctionPpredicatsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<HillsNodeDescriptor> childDescriptors = HillsDiagramUpdater
				.getFunctionFunctionPpredicatsCompartment_7025SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<HillsNodeDescriptor> childDescriptors = HillsDiagramUpdater
				.getFunctionFunctionPpredicatsCompartment_7025SemanticChildren((View) getHost().getModel());
