 ...
 * @generated
 */
public class PropertyPropertyPpredicatsCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return HillsPackage.eINSTANCE.getProperty_Ppredicats();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<HillsNodeDescriptor> childDescriptors = HillsDiagramUpdater
				.getPropertyPropertyPpredicatsCompartment_7020SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return PortDeclarationEditPart.VISUAL_ID == HillsVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<HillsNodeDescriptor> childDescriptors = HillsDiagramUpdater
				.getPropertyPropertyPpredicatsCompartment_7020SemanticChildren((View) getHost().getModel());
