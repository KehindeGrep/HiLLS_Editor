 ...
 * @generated
 */
public class ActivityActivityPpredicatsCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<HillsNodeDescriptor> childDescriptors = HillsDiagramUpdater
				.getActivityActivityPpredicatsCompartment_7021SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<HillsNodeDescriptor> childDescriptors = HillsDiagramUpdater
				.getActivityActivityPpredicatsCompartment_7021SemanticChildren((View) getHost().getModel());
