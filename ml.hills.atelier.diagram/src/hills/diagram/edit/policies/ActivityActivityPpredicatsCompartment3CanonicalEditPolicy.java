 ...
 * @generated
 */
public class ActivityActivityPpredicatsCompartment3CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return HillsPackage.eINSTANCE.getActivity_Ppredicats();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<HillsNodeDescriptor> childDescriptors = HillsDiagramUpdater
				.getActivityActivityPpredicatsCompartment_7023SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return PortDeclaration2EditPart.VISUAL_ID == HillsVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<HillsNodeDescriptor> childDescriptors = HillsDiagramUpdater
				.getActivityActivityPpredicatsCompartment_7023SemanticChildren((View) getHost().getModel());
