 ...
 * @generated
 */
public class PropertyPropertyPpredicatsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<HillsNodeDescriptor> childDescriptors = HillsDiagramUpdater
				.getPropertyPropertyPpredicatsCompartment_7018SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<HillsNodeDescriptor> childDescriptors = HillsDiagramUpdater
				.getPropertyPropertyPpredicatsCompartment_7018SemanticChildren((View) getHost().getModel());
