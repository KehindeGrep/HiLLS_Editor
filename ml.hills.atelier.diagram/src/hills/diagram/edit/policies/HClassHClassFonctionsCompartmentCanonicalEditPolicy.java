 ...
 * @generated
 */
public class HClassHClassFonctionsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return HillsPackage.eINSTANCE.getHClass_Fonctions();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<HillsNodeDescriptor> childDescriptors = HillsDiagramUpdater
				.getHClassHClassFonctionsCompartment_7012SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return Function2EditPart.VISUAL_ID == HillsVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<HillsNodeDescriptor> childDescriptors = HillsDiagramUpdater
				.getHClassHClassFonctionsCompartment_7012SemanticChildren((View) getHost().getModel());
