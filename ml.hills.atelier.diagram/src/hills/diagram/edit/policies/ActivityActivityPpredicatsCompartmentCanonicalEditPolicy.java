 ...
 * @generated
 */
public class ActivityActivityPpredicatsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<HillsNodeDescriptor> childDescriptors = HillsDiagramUpdater
				.getActivityActivityPpredicatsCompartment_7019SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<HillsNodeDescriptor> childDescriptors = HillsDiagramUpdater
				.getActivityActivityPpredicatsCompartment_7019SemanticChildren((View) getHost().getModel());
