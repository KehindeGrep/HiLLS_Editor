 ...
 * @generated
 */
public class FunctionFunctionPpredicatsCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return HillsPackage.eINSTANCE.getFunction_Ppredicats();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<HillsNodeDescriptor> childDescriptors = HillsDiagramUpdater
				.getFunctionFunctionPpredicatsCompartment_7026SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return PortDeclaration4EditPart.VISUAL_ID == HillsVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<HillsNodeDescriptor> childDescriptors = HillsDiagramUpdater
				.getFunctionFunctionPpredicatsCompartment_7026SemanticChildren((View) getHost().getModel());
