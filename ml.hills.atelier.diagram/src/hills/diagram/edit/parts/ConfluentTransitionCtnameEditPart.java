...
import hills.diagram.edit.policies.HillsTextSelectionEditPolicy;
 ...
 * @generated
 */
public class ConfluentTransitionCtnameEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				HillsVisualIDRegistry.getType(hills.diagram.edit.parts.ConfluentTransitionCtnameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public ConfluentTransitionCtnameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new HillsTextSelectionEditPolicy());
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = HillsParserProvider.getParser(HillsElementTypes.ConfluentTransition_4004, getParserElement(),
					HillsVisualIDRegistry
							.getType(hills.diagram.edit.parts.ConfluentTransitionCtnameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, HillsEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ConfluentTransitionLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ConfluentTransitionLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ConfluentTransitionLabelFigure() {
			this.setText("ConfluentTransition");
		}
