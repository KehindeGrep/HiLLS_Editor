 ...
 * @generated
 */
public class InternalTransitionItnameEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				HillsVisualIDRegistry.getType(hills.diagram.edit.parts.InternalTransitionItnameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public InternalTransitionItnameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = HillsParserProvider.getParser(HillsElementTypes.InternalTransition_4005, getParserElement(),
					HillsVisualIDRegistry.getType(hills.diagram.edit.parts.InternalTransitionItnameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new InternalTransitionLabelFigure();
	}

	/**
	 * @generated
	 */
	public class InternalTransitionLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public InternalTransitionLabelFigure() {
			this.setText("InternalTransition");
		}
