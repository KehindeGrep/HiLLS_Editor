 ...
 * @generated
 */
public class HClassNtimeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public HClassNtimeEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = HillsParserProvider.getParser(HillsElementTypes.HClass_2002, getParserElement(),
					HillsVisualIDRegistry.getType(hills.diagram.edit.parts.HClassNtimeEditPart.VISUAL_ID));
		}
		return parser;
	}
