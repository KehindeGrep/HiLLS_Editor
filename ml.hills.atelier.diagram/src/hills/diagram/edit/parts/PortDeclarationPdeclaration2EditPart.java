 ...
 * @generated
 */
public class PortDeclarationPdeclaration2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PortDeclarationPdeclaration2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = HillsParserProvider.getParser(HillsElementTypes.PortDeclaration_3023, getParserElement(),
					HillsVisualIDRegistry
							.getType(hills.diagram.edit.parts.PortDeclarationPdeclaration2EditPart.VISUAL_ID));
		}
		return parser;
	}
