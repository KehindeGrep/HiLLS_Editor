 ...
 * @generated
 */
public class AggregationLlabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				HillsVisualIDRegistry.getType(hills.diagram.edit.parts.AggregationLlabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public AggregationLlabelEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = HillsParserProvider.getParser(HillsElementTypes.Aggregation_4002, getParserElement(),
					HillsVisualIDRegistry.getType(hills.diagram.edit.parts.AggregationLlabelEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new AggregationLabelFigure();
	}

	/**
	 * @generated
	 */
	public class AggregationLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public AggregationLabelFigure() {
			this.setText("Aggregation");
		}
