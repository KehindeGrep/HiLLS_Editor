 ...
 * @generated
 */
public class PropertyPrname1EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PropertyPrname1EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = HillsParserProvider.getParser(HillsElementTypes.Property_3002, getParserElement(),
					HillsVisualIDRegistry.getType(hills.diagram.edit.parts.PropertyPrname1EditPart.VISUAL_ID));
		}
		return parser;
	}
