 ...
 * @generated
 */
public class ExternalTransitionEtnameEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				HillsVisualIDRegistry.getType(hills.diagram.edit.parts.ExternalTransitionEtnameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public ExternalTransitionEtnameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = HillsParserProvider.getParser(HillsElementTypes.ExternalTransition_4006, getParserElement(),
					HillsVisualIDRegistry.getType(hills.diagram.edit.parts.ExternalTransitionEtnameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ExternalTransitionLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ExternalTransitionLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ExternalTransitionLabelFigure() {
			this.setText("ExternalTransition");
		}
