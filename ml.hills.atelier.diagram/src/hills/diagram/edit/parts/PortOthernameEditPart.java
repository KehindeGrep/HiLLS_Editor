 ...
 * @generated
 */
public class PortOthernameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PortOthernameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = HillsParserProvider.getParser(HillsElementTypes.Port_3013, getParserElement(),
					HillsVisualIDRegistry.getType(hills.diagram.edit.parts.PortOthernameEditPart.VISUAL_ID));
		}
		return parser;
	}
