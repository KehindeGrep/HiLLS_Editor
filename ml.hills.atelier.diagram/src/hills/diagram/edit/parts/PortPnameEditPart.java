 ...
 * @generated
 */
public class PortPnameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PortPnameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = HillsParserProvider.getParser(HillsElementTypes.Port_3013, getParserElement(),
					HillsVisualIDRegistry.getType(hills.diagram.edit.parts.PortPnameEditPart.VISUAL_ID));
		}
		return parser;
	}
