 ...
 * @generated
 */
public class GenericNodeNtimeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public GenericNodeNtimeEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = HillsParserProvider.getParser(HillsElementTypes.GenericNode_2003, getParserElement(),
					HillsVisualIDRegistry.getType(hills.diagram.edit.parts.GenericNodeNtimeEditPart.VISUAL_ID));
		}
		return parser;
	}
