 ...
 * @generated
 */
public class FunctionFnameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public FunctionFnameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = HillsParserProvider.getParser(HillsElementTypes.Function_3015, getParserElement(),
					HillsVisualIDRegistry.getType(hills.diagram.edit.parts.FunctionFnameEditPart.VISUAL_ID));
		}
		return parser;
	}
