 ...
 * @generated
 */
public class InitialConfigurationLibelleEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public InitialConfigurationLibelleEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = HillsParserProvider.getParser(HillsElementTypes.InitialConfiguration_3005, getParserElement(),
					HillsVisualIDRegistry
							.getType(hills.diagram.edit.parts.InitialConfigurationLibelleEditPart.VISUAL_ID));
		}
		return parser;
	}
