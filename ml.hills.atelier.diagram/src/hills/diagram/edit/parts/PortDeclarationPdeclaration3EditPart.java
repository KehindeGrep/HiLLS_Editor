 ...
 * @generated
 */
public class PortDeclarationPdeclaration3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PortDeclarationPdeclaration3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = HillsParserProvider.getParser(HillsElementTypes.PortDeclaration_3024, getParserElement(),
					HillsVisualIDRegistry
							.getType(hills.diagram.edit.parts.PortDeclarationPdeclaration3EditPart.VISUAL_ID));
		}
		return parser;
	}
