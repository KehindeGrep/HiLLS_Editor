 ...
 * @generated
 */
public class DeclarationEnameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public DeclarationEnameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = HillsParserProvider.getParser(HillsElementTypes.Declaration_3014, getParserElement(),
					HillsVisualIDRegistry.getType(hills.diagram.edit.parts.DeclarationEnameEditPart.VISUAL_ID));
		}
		return parser;
	}
