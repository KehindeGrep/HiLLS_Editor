 ...
 * @generated
 */
public class DeclarationEname2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public DeclarationEname2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = HillsParserProvider.getParser(HillsElementTypes.Declaration_3016, getParserElement(),
					HillsVisualIDRegistry.getType(hills.diagram.edit.parts.DeclarationEname2EditPart.VISUAL_ID));
		}
		return parser;
	}
