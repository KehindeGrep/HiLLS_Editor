 ...
 * @generated
 */
public class FiniteConfigurationLibelleEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public FiniteConfigurationLibelleEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = HillsParserProvider.getParser(HillsElementTypes.FiniteConfiguration_3001, getParserElement(),
					HillsVisualIDRegistry
							.getType(hills.diagram.edit.parts.FiniteConfigurationLibelleEditPart.VISUAL_ID));
		}
		return parser;
	}
