 ...
 * @generated
 */
public class UExistenceUenameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public UExistenceUenameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = HillsParserProvider.getParser(HillsElementTypes.UExistence_3019, getParserElement(),
					HillsVisualIDRegistry.getType(hills.diagram.edit.parts.UExistenceUenameEditPart.VISUAL_ID));
		}
		return parser;
	}
