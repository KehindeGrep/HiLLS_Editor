...
import hills.diagram.edit.policies.Function2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Function2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public Function2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Function2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof FunctionFname2EditPart) {
			((FunctionFname2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureFunctionLabelFigure());
			return true;
		}
		if (childEditPart instanceof FunctionFunctionPpredicatsCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getFunctionPpredicatsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((FunctionFunctionPpredicatsCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof FunctionFunctionPpredicatsCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getFunctionPpredicatsCompartmentFigure();
			pane.remove(((FunctionFunctionPpredicatsCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof FunctionFunctionPpredicatsCompartment2EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(HillsVisualIDRegistry.getType(FunctionFname2EditPart.VISUAL_ID));
	}
