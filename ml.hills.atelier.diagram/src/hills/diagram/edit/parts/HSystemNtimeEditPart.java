 ...
 * @generated
 */
public class HSystemNtimeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public HSystemNtimeEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = HillsParserProvider.getParser(HillsElementTypes.HSystem_2001, getParserElement(),
					HillsVisualIDRegistry.getType(hills.diagram.edit.parts.HSystemNtimeEditPart.VISUAL_ID));
		}
		return parser;
	}
