 ...
 * @generated
 */
public class FunctionFname2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public FunctionFname2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = HillsParserProvider.getParser(HillsElementTypes.Function_3017, getParserElement(),
					HillsVisualIDRegistry.getType(hills.diagram.edit.parts.FunctionFname2EditPart.VISUAL_ID));
		}
		return parser;
	}
