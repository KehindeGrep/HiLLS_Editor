 ...
 * @generated
 */
public class EExistenceEenameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public EExistenceEenameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = HillsParserProvider.getParser(HillsElementTypes.EExistence_3020, getParserElement(),
					HillsVisualIDRegistry.getType(hills.diagram.edit.parts.EExistenceEenameEditPart.VISUAL_ID));
		}
		return parser;
	}
