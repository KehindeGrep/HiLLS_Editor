 ...
 * @generated
 */
public class HRequirementSpecificationNtimeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public HRequirementSpecificationNtimeEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = HillsParserProvider.getParser(HillsElementTypes.HRequirementSpecification_2004, getParserElement(),
					HillsVisualIDRegistry
							.getType(hills.diagram.edit.parts.HRequirementSpecificationNtimeEditPart.VISUAL_ID));
		}
		return parser;
	}
