 ...
 * @generated
 */
public class CAbsenceCanameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CAbsenceCanameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = HillsParserProvider.getParser(HillsElementTypes.CAbsence_3021, getParserElement(),
					HillsVisualIDRegistry.getType(hills.diagram.edit.parts.CAbsenceCanameEditPart.VISUAL_ID));
		}
		return parser;
	}
