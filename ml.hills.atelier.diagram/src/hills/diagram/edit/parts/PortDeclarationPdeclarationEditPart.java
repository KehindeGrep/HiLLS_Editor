 ...
 * @generated
 */
public class PortDeclarationPdeclarationEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PortDeclarationPdeclarationEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = HillsParserProvider.getParser(HillsElementTypes.PortDeclaration_3022, getParserElement(),
					HillsVisualIDRegistry
							.getType(hills.diagram.edit.parts.PortDeclarationPdeclarationEditPart.VISUAL_ID));
		}
		return parser;
	}
