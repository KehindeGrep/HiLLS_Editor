 ...
 * @generated
 */
public class SojournTimeStimeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public SojournTimeStimeEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = HillsParserProvider.getParser(HillsElementTypes.SojournTime_3004, getParserElement(),
					HillsVisualIDRegistry.getType(hills.diagram.edit.parts.SojournTimeStimeEditPart.VISUAL_ID));
		}
		return parser;
	}
