 ...
 * @generated
 */
public class ActivityAcname1EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ActivityAcname1EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = HillsParserProvider.getParser(HillsElementTypes.Activity_3003, getParserElement(),
					HillsVisualIDRegistry.getType(hills.diagram.edit.parts.ActivityAcname1EditPart.VISUAL_ID));
		}
		return parser;
	}
