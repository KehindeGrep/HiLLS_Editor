 ...
 * @generated
 */
public class TestNodeTtimeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public TestNodeTtimeEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = HillsParserProvider.getParser(HillsElementTypes.TestNode_3012, getParserElement(),
					HillsVisualIDRegistry.getType(hills.diagram.edit.parts.TestNodeTtimeEditPart.VISUAL_ID));
		}
		return parser;
	}
