 ...
 * @generated
 */
public class BExistenceBenameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public BExistenceBenameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = HillsParserProvider.getParser(HillsElementTypes.BExistence_3018, getParserElement(),
					HillsVisualIDRegistry.getType(hills.diagram.edit.parts.BExistenceBenameEditPart.VISUAL_ID));
		}
		return parser;
	}
