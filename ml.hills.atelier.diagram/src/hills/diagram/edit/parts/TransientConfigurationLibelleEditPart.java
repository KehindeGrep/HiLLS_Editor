 ...
 * @generated
 */
public class TransientConfigurationLibelleEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public TransientConfigurationLibelleEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = HillsParserProvider.getParser(HillsElementTypes.TransientConfiguration_3009, getParserElement(),
					HillsVisualIDRegistry
							.getType(hills.diagram.edit.parts.TransientConfigurationLibelleEditPart.VISUAL_ID));
		}
		return parser;
	}
