 ...
 * @generated
 */
public class PortDeclarationPdeclaration4EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PortDeclarationPdeclaration4EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = HillsParserProvider.getParser(HillsElementTypes.PortDeclaration_3025, getParserElement(),
					HillsVisualIDRegistry
							.getType(hills.diagram.edit.parts.PortDeclarationPdeclaration4EditPart.VISUAL_ID));
		}
		return parser;
	}
