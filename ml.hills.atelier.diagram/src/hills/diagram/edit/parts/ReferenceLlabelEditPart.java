 ...
 * @generated
 */
public class ReferenceLlabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				HillsVisualIDRegistry.getType(hills.diagram.edit.parts.ReferenceLlabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public ReferenceLlabelEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = HillsParserProvider.getParser(HillsElementTypes.Reference_4003, getParserElement(),
					HillsVisualIDRegistry.getType(hills.diagram.edit.parts.ReferenceLlabelEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ReferenceLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ReferenceLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ReferenceLabelFigure() {
