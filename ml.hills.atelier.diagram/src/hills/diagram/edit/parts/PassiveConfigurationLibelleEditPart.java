 ...
 * @generated
 */
public class PassiveConfigurationLibelleEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PassiveConfigurationLibelleEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = HillsParserProvider.getParser(HillsElementTypes.PassiveConfiguration_3006, getParserElement(),
					HillsVisualIDRegistry
							.getType(hills.diagram.edit.parts.PassiveConfigurationLibelleEditPart.VISUAL_ID));
		}
		return parser;
	}
